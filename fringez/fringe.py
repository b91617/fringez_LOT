...
def gather_flat_fringe_maps(N_samples, parallelFlag):
    ...
    """
    fname_arr, fringes = gather_fringe_maps(N_samples, parallelFlag)
    """ rcid """
    fringe_maps_flattened, image_shape = flatten_images(fringes)
    return fname_arr, fringe_maps_flattened, image_shape
    """ rcid """
...
def gather_fringe_maps(N_samples, parallelFlag):
    ...
    if rank == 0:
        ...
        fringe_filename_arr = glob.glob('*2017.fts')
    ...
    return fringe_filename_arr, fringe_maps 
    """ rcid """
...
def remove_fringe(image_name,
    ...
    image_clean_fname = image_name.replace('.fts', '_clean.fts')
